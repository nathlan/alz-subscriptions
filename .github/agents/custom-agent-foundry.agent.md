...
- **awesome-copilot tools**: For leveraging existing prompt/instruction collections you can pull relevant prompts, agent instructions etc from the `awesome-copilot/*` MCP tools to quickly equip agents with powerful capabilities without reinventing the wheel.
